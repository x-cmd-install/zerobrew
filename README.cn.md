...
[![x-cmd/install — zerobrew Code Quality Monitoring Repo Card](https://repo.x-cmd.io/zerobrew.svg?lang=zh)](https://x-cmd.com/install/zerobrew)
...
合计: **22,617** 行代码（覆盖前 5 种语言、共 **91** 个文件）。
...
- **上游仓库**: <https://github.com/lucasgelfond/zerobrew>
- **许可证**: Apache-2.0
...
- **Star**: 7,539 · **Fork**: 181 · **开放 issue**: 152 · **贡献者**: 32

## 累计统计

- **发布数**: 7 · **已合并 PR**: 156 · **开放 PR**: 4 · **已关闭 issue**: 108 · **开放 issue**: 44 · **提交数**: 395

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-22 | 0 | 0 | 4 | 0 | 4 | 1 |
| last60d | 2026-07-23 | 0 | 1 | 4 | 1 | 6 | 1 |
| 90d | 2026-06-23 | 0 | 1 | 4 | 2 | 6 | 4 |
| last180d | 2026-03-25 | 3 | 20 | 4 | 11 | 24 | 49 |
| 360d | 2025-09-26 | 7 | 156 | 4 | 108 | 44 | 377 |
| last720d | 2024-10-01 | 7 | 156 | 4 | 108 | 44 | 395 |
...
zerobrew 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `zerobrew` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/zerobrew.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260921.yml` · 2026-09-21T05:32:35Z._
